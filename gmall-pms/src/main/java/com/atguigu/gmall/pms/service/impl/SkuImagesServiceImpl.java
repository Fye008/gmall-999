...
public class SkuImagesServiceImpl extends ServiceImpl<SkuImagesMapper, SkuImagesEntity> implements SkuImagesService {
    ...
    @Override
    public List<SkuImagesEntity> queryImages(Long skuId) {

        List<SkuImagesEntity> skuImagesEntities =   skuImagesMapper.selectList(new QueryWrapper<SkuImagesEntity>().eq("sku_id",skuId));
