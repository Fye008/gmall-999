...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> queryBrandPageByCategoryId(
            @PathVariable("categoryId") Long categoryId,  PageParamVo pageParamVo){

        PageResultVo pageResultVo = spuService.queryBrandPageByCategoryId(categoryId,pageParamVo);
    ...
    public ResponseVo update(@RequestBody SpuEntity spu){
		...
		rabbitTemplate.convertAndSend("PMS_ITEM_EXCHANGE","spu_update",spu.getId());
